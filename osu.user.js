...
const Beatmap = (arr, iter) => {
    return {
        ...
        osuSRInfoArr: (iter.osuVersion >= 20140609) ? IntFloatArray(arr, iter) : undefined,
        taikoSRInfoArr: (iter.osuVersion >= 20140609) ? IntFloatArray(arr, iter) : undefined,
        catchSRInfoArr: (iter.osuVersion >= 20140609) ? IntFloatArray(arr, iter) : undefined,
        maniaSRInfoArr: (iter.osuVersion >= 20140609) ? IntFloatArray(arr, iter) : undefined,
